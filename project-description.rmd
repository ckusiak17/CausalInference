...
summary(obs.data[,-c(1,2)])

obs.data <- mutate(obs.data, PhysActive = ifelse(PhysActive == "Yes", 1, 0),
                   SleepTrouble = ifelse(SleepTrouble == "Yes", 1, 0))
save(obs.data, file = "obs_data.Rda")
```
